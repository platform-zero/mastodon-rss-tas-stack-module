# Mastodon RSS Tasmania stack module

Content-only Platform Zero module providing curated Tasmanian news feeds and Mastodon bootstrap follows to `mastodon-rss-publisher`.
